            ...
            <table class="w-full text-sm text-left border-collapse">
                ...
                <tbody id="tabelKeluar" class="divide-y divide-slate-100">
                    ...
                    <tr class="baris-data hover:bg-slate-50 text-slate-700 transition-colors" 
                        ...
                        data-item="Plywood / Triplek"
                        data-spesifikasi="Mercy (18mm)"
                        data-qty="12 Lbr"
                        data-volume="- 12 Lembar"
                        ...
                        <td class="p-3.5 text-xs">
                            <button onclick="hitungRasioKonsumsi(this)" class="text-left flex flex-col group">
                                <span class="font-semibold text-slate-700 underline group-hover:text-indigo-600">Resto Namora</span> 
                                <span class="text-slate-400 font-normal mt-0.5">🏭 Kitchen Set Jati (2 Unit)</span>
                            </button>
                        </td>
                    </tr>
                    ...
                    <tr class="baris-data hover:bg-slate-50 text-slate-700 transition-colors" 
                        ...
                        data-item="Amplas Roll"
                        data-spesifikasi="Kekasaran: Grid 240"
                        data-qty="3 Mtr"
                        data-volume="- 3 Meter"
                        ...
                        <td class="p-3.5 text-xs text-slate-400 italic">
                            General Workshop <br>
                            <span class="text-[11px] text-slate-400/80 font-normal">Maintenance / Finishing Room</span>
                        </td>
                    </tr>
                </tbody>
            </table>
